%define mod_name augeasproviders_puppet

Summary: Puppet Configuration File Augeas-based providers for Puppet
Name: pupmod-augeasproviders_puppet
Version: 2.0.1
Release: 0
...
%description
This module provides types/providers for Puppet configuration files using the Augeas configuration API library.
